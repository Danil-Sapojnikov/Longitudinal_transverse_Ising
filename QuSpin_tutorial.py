...
# entropy = basis_2.ent_entropy(psi_GS, sub_sys_A=[0,],return_rdm='both', alpha=1)
# print(entropy)
...
Jzz_list.append([Jzz, L-1,0]) # Periodic B.C. wrap-around bond
...
# sparse eigensolver
#E, V = H_Ising.eigsh(k=10, which='SA')
